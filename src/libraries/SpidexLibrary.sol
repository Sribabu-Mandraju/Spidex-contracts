...
library SpidexLibrary {
    ...
    function getAmountOut(uint256 amountIn,uint112 _reserveIn,uint112 _reserveOut) internal pure returns (uint256 amountOut) {
    ...
    function getAmountIn(uint256 amountOut,uint112 _reserveIn,uint112 _reserveOut) internal pure returns (uint256 amountIn) {
    ...
    function getReserves(address factory ,address inputToken,address outputToken) internal view  returns (uint112 _reserveIn,uint112 _reserveOut) {
